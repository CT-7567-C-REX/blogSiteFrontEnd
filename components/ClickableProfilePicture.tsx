  ...
  return (
    ...
    >
      {imageUrl ? (
        ...
        <div className={`${sizeClasses[size]} rounded-full bg-gray-200 dark:bg-gray-800 flex items-center justify-center transition-all duration-200 group-hover:opacity-80`}>
          <svg 
